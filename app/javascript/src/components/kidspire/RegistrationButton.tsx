...
import { KidspireApiError } from "@/lib/api"
...
export function RegistrationButton({
  ...
  async function handleRegister() {
    ...
    catch (e) { setError(e instanceof KidspireApiError ? e.message : "Registration failed") }
  ...
  async function handleCancel() {
    ...
    catch (e) { setError(e instanceof KidspireApiError ? e.message : "Could not cancel") }
    finally { setPending(false) }
  }
