      ...
      class SyncController < BaseController
        ...
        def trigger
          ...
          if settings.inbound_people_sync?
            Kidspire::PcoInboundPeopleSyncJob.perform_later
          ...
          if settings.outbound_people_sync?
            Kidspire::Family.where(pco_sync_enabled: true).find_each do |family|
              Kidspire::PcoOutboundProfileSyncJob.perform_later(family.id)
            end
