module Kidspire
  class ChurchIntegration < ApplicationRecord
    ...
    def access_token
      Kidspire::Encryption.decrypt(self[:access_token])
    end

    def access_token=(value)
      self[:access_token] = Kidspire::Encryption.encrypt(value)
    end

    def refresh_token
      Kidspire::Encryption.decrypt(self[:refresh_token])
    end

    def refresh_token=(value)
      self[:refresh_token] = Kidspire::Encryption.encrypt(value)
    end
