...
RSpec.describe Kidspire::Registration, type: :model do
  describe "validations" do
    ...
    it "prevents registering a child who belongs to a different family" do
      family_a  = create(:spirely_family)
      family_b  = create(:spirely_family)
      child_b   = create(:spirely_child, family: family_b)
    ...
    it "prevents registering a child outside the event's age range" do
      ...
      family     = create(:spirely_family)
      young_child = create(:spirely_child, family: family, birthdate: 6.years.ago.to_date)
